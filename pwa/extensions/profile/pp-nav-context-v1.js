...
(function () {
  ...
  var PARENT_MAP = {
    ...
    'brand_campagnes':       { page: 'brand_dashboard' },
    'brand_campagne_nieuw':  { page: 'brand_campagnes' },
    'brand_products':        { page: 'brand_dashboard' },
    'brand_producten':       { page: 'brand_dashboard' },
    'brand_product_nieuw':   { page: 'brand_producten' },
    'brand_profiel':         { page: 'brand_dashboard' },
    'brand_wallet':          { page: 'brand_dashboard' },
    'brand_settings':        { page: 'brand_dashboard' },
    'brand_onboarding':      { page: 'brand_dashboard' },
    'brand_pending':         { page: 'feed' },
    'brand_register':        { page: 'feed' },
    'campagne_detail':       { page: 'merken' },
    'product_detail':        { page: 'merken' },
    'detail':                { page: 'merken' },
    'merken_pakketten':      { page: 'merken' },
    // B2C profiel / account
    'profiel':               { page: 'feed' },
    'profiel_bewerken':      { page: 'profiel' },
    'body_profile':          { page: 'profiel' },
    'bestellingen':          { page: 'profiel' },
    'privacy_center':        { page: 'instellingen' },
    'account_verwijder':     { page: 'instellingen' },
    'vrienden':              { page: 'profiel' },
    // Wallet & payments
    'wallet':                { page: 'profiel' },
    ...
    'home':                  { page: 'feed' },
    'nieuw':                 { page: 'feed' },
    'post_detail':           { page: 'feed' },
    'lookbook_detail':       { page: 'feed' },
    'lookbook_nieuw':        { page: 'feed' },
    'story_poster':          { page: 'feed' },
    'berichten':             { page: 'feed' },
    'bericht_detail':        { page: 'berichten' },
    'notificaties':          { page: 'feed' },
    'zoeken':                { page: 'feed' },
    'challenges':            { page: 'feed' },
    'ovdw':                  { page: 'feed' },
    'configurator':          { page: 'feed' },
    'dsp':                   { page: 'feed' },
    // Reviews (public)
    'reviews':               { page: 'merken' },
    'reviews_nieuw':         { page: 'merken' },
    // Live / Studio
    'live':                  { page: 'feed' },
    // Legal
    'voorwaarden':           { page: 'feed' },
    ...
    'admin_brands':          { page: 'admin' },
    'admin_campagnes':       { page: 'admin' },
    'admin_campagne_diagnose': { page: 'admin_campagnes' },
    'admin_imggen':          { page: 'admin' },
    'admin_inkomsten':       { page: 'admin' },
    'admin_premium':         { page: 'admin' }
  };
