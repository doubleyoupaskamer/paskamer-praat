...
(function () {
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '}'
      /* v60.1.213: verberg originele Contact-knop op home hero — verplaatst naar footer */
      + '.dy-hm-hero-actions .dy-hm-hero-legal {'
      +   'display: none !important;'
      + '}'
      ...
      +   'font-size: 0.66rem;'
      + '}'
      /* Contact link gecentreerd onder de legal-links, zelfde stijl */
      + '.pp-legal-inline-contact {'
      +   'margin-top: 6px;'
      +   'text-align: center;'
      +   'font-size: 0.68rem;'
      +   'line-height: 1.4;'
      + '}'
      + '.pp-legal-inline-contact a {'
      +   'color: rgba(254,252,245,0.55);'
      +   'text-decoration: none;'
      +   'transition: color 0.18s ease;'
      + '}'
      + '.pp-legal-inline-contact a:hover {'
      +   'color: rgba(254,252,245,0.9);'
      +   'text-decoration: underline;'
      + '}'
  ...
  function buildInlineBlock() {
    ...
    wrap.innerHTML = ''
      ...
      + '</div>'
      + '<div class="pp-legal-inline-contact">'
      +   '<a href="mailto:info@doubleyousmallandtall.nl" data-testid="legal-inline-contact">Contact</a>'
      + '</div>'
